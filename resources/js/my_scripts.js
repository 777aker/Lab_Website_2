...
function loadStatsPage() {
	...
	var wins = 0;
	var losses = 0;
	for(var r = 2; r < statsTable.rows.length; r++) {
		if(statsTable.rows[r].cells[2].innerHTML < statsTable.rows[r].cells[3].innerHTML) {
			statsTable.rows[r].cells[4].innerHTML = statsTable.rows[r].cells[1].innerHTML;
			losses += 1;
		} else {
			statsTable.rows[r].cells[4].innerHTML += "CU Boulder";
			wins += 1;
		}
	}
...
function switchPlayers(playerNum) {
	...
	var avg_p = (player.pass_yards/player.games_played).toFixed(0);
	document.getElementById("avg_p_yards").innerHTML = avg_p;
	document.getElementById("r_yards").innerHTML = player.rushing_yards;
	var avg_r = (player.rushing_yards/player.games_played).toFixed(0);
	document.getElementById("avg_r_yards").innerHTML = avg_r;
	document.getElementById("rec_yards").innerHTML = player.receiving_yards;
	var avg_re = (player.receiving_yards/player.games_played).toFixed(0);
	document.getElementById("avg_rec_yards").innerHTML = avg_re;
